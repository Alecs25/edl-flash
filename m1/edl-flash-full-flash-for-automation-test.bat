...
set /p COM_NUMBER=Pls Input COM port(eg: COM3) or press "Enter" key to detect COM port automatically:
set LOOP_TIME=0
:LOOP
if "%COM_NUMBER%"=="" (
	set COM_NUMBER=
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram_unsparse0_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram1_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram2_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram3_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram_unsparse4_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
...
%FHLOADER_EXE% --port=\\.\%COM_NUMBER% --sendxml=rawprogram5_full_flash.xml --search_path=%DIR_PATH% --noprompt --showpercentagecomplete --zlpawarehost=1 --memoryname=UFS
